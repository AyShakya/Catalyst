...
async function handleWebhookEvent(req, res) {
  ...
  try {
    ...
    for (const evt of events) {
      ...
      // Always record the event audit trail - use ON CONFLICT DO NOTHING to prevent race conditions
      await client.query(
        `INSERT INTO communication_events (communication_id, event_type, timestamp, payload) 
         VALUES ($1, $2, $3, $4)
         ON CONFLICT (communication_id, event_type) DO NOTHING`,
